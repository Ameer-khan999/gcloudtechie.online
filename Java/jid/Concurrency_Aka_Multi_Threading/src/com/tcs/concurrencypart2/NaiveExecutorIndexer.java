...
import com.tcs.concurrencypart11.HttpConnect;
...
// This program wastes the cpu cycles by itearting continuously in while loop..
public class NaiveExecutorIndexer {
	...
	private static class Weblink {
	    ...
	    private volatile String htmlPage; // gives memory visibilty to other Thread like
	    // page is downloaded or not.
