...
// 3 rd party packages thats why we are getting errors lets dont worry about it just remind knowledge


public class DataTranslatorUsingLocalClasses {	
	...
	public static void main(String[] args) {
		System.out.println(DataTranslatorUsingLocalClasses.getBookAsXml(2002, "Interface vs Abstract Class", 3.0, 5, 6));
	}
}
*/
// Note:- rest API return data in xml or json
