...
public class InstructorDemo <T> {
	
	// Generic Constructors are rare!!
	<E extends T> InstructorDemo(E object) { }
	...
	static void genericMethodsDemo() {
		...
		InstructorDemo.targetTypeInvoker1(typeArgInferenceFromTargetType2()); // Eclipse Mars showing incorrect type arg
		InstructorDemo.targetTypeInvoker1(new ArrayList<>()); // Eclipse Mars showing incorrect type arg
		InstructorDemo.targetTypeInvoker2(typeArgInferenceFromTargetType2()); // Infers as Object
		List<String> strList = InstructorDemo.targetTypeInvoker2(typeArgInferenceFromTargetType2());
		InstructorDemo.targetTypeInvoker2(new ArrayList<>());
		List<String> strList2 = InstructorDemo.targetTypeInvoker2(new ArrayList<>());
		...
		InstructorDemo.<String>uselessGenericMethod(); // type witness
		...
		new InstructorDemo<Number>(12.0); // T is Number, E is Double
		new InstructorDemo<>(12.0); // T & E are Double
		new <Double>InstructorDemo<Number>(12.0); // Type witness!!
		//new <Double>GenericsDemo<>(12.0); // Could have inferred from arg
		InstructorDemo<Number> gd = new InstructorDemo<>(12.0); // To avoid invariance, smartly infers Number for <> rather than Double 
