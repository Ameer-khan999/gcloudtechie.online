 ...
 * 
 * @author ameer
 * note:- ArrayList and LinkedList both performance is same, we copied the entire code of ArrayListDemo
 *        by changing the name only as LinkedList. remaining code is same for both.
 */

public class LinkedListDemo {
	private static void  linkedListDemoWithCollections() {
