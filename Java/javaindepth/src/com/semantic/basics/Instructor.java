public class Instructor {
	...
	/* Common Mistakes 
	 1.Not using temp variable
	 2.oldBook & books[index] referencing same book object.
	 */
	
	public static void main(String[] args) {
		Book book1 = new Book("Java for Beginners");
        Book book2 = new Book("Scala for Beginners");
        Book book3 = new Book("Effective Python 3");
		...
		System.out.println("old book4 title: " + instructor.updateBook(2,book4).getTitle());
